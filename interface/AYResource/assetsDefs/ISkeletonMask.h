// AYResource/assetsDefs/ISkeletonMask.h — P3.x 刀 1 (2026-08-06) Skeleton Mask resource interface.
//
...
// AYAnimation/AnimationPlayer.h / AnimationSystem.cpp / SkeletonMaskBridge.cpp flip
